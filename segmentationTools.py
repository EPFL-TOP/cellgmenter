...
#_______________________________________________
def customLocalThresholding_Segmentation(img,  outdir, thr=2., delta=1, npix=400):
...
#_______________________________________________
def apoc_Segmentation(img, outdir, npix=300):
    clf = apoc.PixelClassifier(opencl_filename="models/pixel_classification.cl")
